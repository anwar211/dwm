...
static const char *fonts[]          = { "sarasa mono sc:size=12" };
static const char dmenufont[]       = "sarasa mono sc:size=12";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,    XK_bracketright,         spawn,          {.v = ligthup } },
